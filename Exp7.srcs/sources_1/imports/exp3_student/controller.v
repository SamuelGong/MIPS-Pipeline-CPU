...
module controller (/*AUTOARG*/
	...
	always @(*) begin
		...
		is_store = 0;                     //
		unrecognized = 0;
		cp0_oper = EXE_CP_NONE;
		case (inst[31:26])
		                                  ////
		    INST_CP0: begin
		        case(inst[25])
		            1:    case(inst[5:0])
		                      CP0_CO_ERET: cp0_oper = EXE_CP0_ERET;
		                      default: ;
		                  endcase
		            0:    case(inst[24:21])
		                      CP_FUNC_MF : begin
	...
	assign is_branch = ( pc_src != PC_NEXT );  //
